...
public class EmpleadoConJefe {
    ...
    /**
     * Devuelve una cadena de caracteres con el CUIL, apellido, nombre y sueldo neto del EmpleadoConJefe.
     * <br>Formato:
    ...
    public boolean esAniversario(){
        Calendar fechaHoy = new GregorianCalendar();
        return fechaHoy.get(Calendar.DAY_OF_YEAR)==this.getFechaIngreso().get(Calendar.DAY_OF_YEAR);
    }
}
